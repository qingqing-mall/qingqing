...
/**
 * accesstoken和用户认证信息的转换器
 *
 * @author liaoyb
 */
public class QingqingUserAuthenticationConverter implements UserAuthenticationConverter {
    ...
    public Authentication extractAuthentication(Map<String, ?> map) {
        if (map.containsKey(USERNAME)) {
            ...
            if(map.get(USERID) != null){
                ...
                Userdetail userdetail = new Userdetail(userId, username, "N/A", authorities);
